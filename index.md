...
can either use the [`x13()`](reference/x13.md) function for the
X-13ARIMA method or the [`tramoseats()`](reference/tramoseats.md)
...
![](reference/figures/README-plot-example-2.png)
